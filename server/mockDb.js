...
export const db = {
  ...
  govtUpdates: [
    {
      id: "gov-up-lpg-01",
      title: "Mandatory e-KYC for LPG Gas Cylinders Before 16th",
      department: "Ministry of Petroleum & Natural Gas (MoPNG) / Indian Oil, HP, Bharat Petroleum",
      source: "Official Public Notice — MoPNG",
      category: "Compliance Mandate",
      content: "All LPG domestic gas cylinder connection holders (Indane / Indian Oil, HP Gas, Bharat Gas) must complete bio-metric or Aadhaar e-KYC before the 16th of this month to ensure uninterrupted LPG subsidy transfer to bank accounts.",
      summary: "LPG domestic gas e-KYC mandatory before 16th to retain subsidy.",
    ...
    {
      id: "gov-up-pan-02",
      title: "CBDT Mandatory Aadhaar-PAN Card Linking Directive",
      department: "Central Board of Direct Taxes (CBDT) / Income Tax Dept",
      source: "CBDT Official Portal Notice",
      category: "Tax Compliance",
      content: "CBDT mandates that all individual taxpayers must link their 12-digit Aadhaar number with Permanent Account Number (PAN). Unlinked PAN cards will be rendered inoperative for bank accounts and ITR filing.",
      summary: "Aadhaar-PAN linking mandatory to avoid inoperative PAN status.",
    ...
    {
      id: "gov-up-rrb-03",
      title: "RRB NTPC & State Teacher Eligibility Test (TET) 2026 Exam Schedule Released",
    ...
    {
      id: "gov-up-hsrp-04",
      title: "MoRTH High-Security Registration Plate (HSRP) & Fuel Sticker Mandate",
      department: "Ministry of Road Transport and Highways (MoRTH)",
      source: "Parivahan Sewa Official Desk",
      category: "Transport",
      content: "All motor vehicles registered prior to April 2019 must be fitted with High-Security Registration Plates (HSRP) and color-coded fuel stickers to comply with Central Motor Vehicles Rules.",
      summary: "HSRP plate & fuel sticker fitting mandatory for pre-2019 vehicles.",
